...
- (void)viewDidLoad
{
    ...
    [_deleteButton setImage:[UIImage imageNamed:@"MJPhotoBrowser.bundle/IDMPhotoBrowser_delete"] forState:UIControlStateNormal];
    [_deleteButton addTarget:self action:@selector(deleteButtonPressed:) forControlEvents:UIControlEventTouchUpInside];
    _deleteButton.frame = CGRectMake(CGRectGetWidth(self.view.bounds) - SCALE(44) -13, 13, SCALE(44), SCALE(44));//binky
    _deleteButton.hidden = !_isShowDeleteButton;
    [self.view addSubview:_deleteButton];
}

-(void)deleteButtonPressed:(UIButton *)sender
{
    if (self.delegate && [_delegate respondsToSelector:@selector(photoBrowser:didDeletePhotoAtIndex:)]) {
        [_delegate photoBrowser:self didDeletePhotoAtIndex:_currentPhotoIndex];
        //将当期图片浏览器销毁

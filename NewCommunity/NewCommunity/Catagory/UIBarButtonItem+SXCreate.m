...
+(UIBarButtonItem *)itemWithTarget:(id)target
    ...
    label.frame = CGRectMake(CGRectGetMaxX(button.frame) - 3, CGRectGetMinY(button.frame) + 13, 8, 8);
    label.layer.cornerRadius = 4;
    label.layer.masksToBounds = YES;
    label.hidden = [[User sharedInstanced].unreadMessages integerValue] == 0 ? YES : NO;
